        ...
        <div className="w-full max-w-md space-y-4 mb-6">
          ...
          <div>
            <button
              ...
              className="w-full relative bg-gradient-to-r from-amber-400 to-yellow-400 text-blue-900 font-extrabold py-4 rounded-full flex items-center justify-center gap-2 hover:from-amber-300 hover:to-yellow-300 shadow-xl transition-all text-lg"
            >
              <span className="absolute -top-2.5 left-4 bg-white text-amber-600 text-[10px] font-black px-2 py-0.5 rounded-full shadow uppercase tracking-wider">Nouveau</span>
              <span>⚡ Recruter en Express</span>
              <ArrowRightIcon className="w-5 h-5" />
            </button>
            <p className="text-blue-100 text-xs text-center mt-1.5">Un extra pour ce soir ou demain, en quelques minutes</p>
          </div>
