...
export const ESTABLISHMENT_TYPES = [
  ...
  { value: 'restaurant_collectif', label: 'Restaurant collectif' },
  { value: 'fast_food', label: 'Fast-food' },
  { value: 'discothèque', label: 'Discothèque / Club' },
...
export const POSITION_TYPES = [
  ...
  { value: 'femme_chambre', label: 'Femme/Valet de chambre' },
  { value: 'equipier', label: 'Équipier polyvalent' },
  { value: 'autre', label: 'Autre' }
]

// Types de contrat
export const CONTRACT_TYPES = [
  { value: 'extra', label: 'Extra (journée/soirée)' },
  { value: 'cdd', label: 'CDD' },
  { value: 'cdi', label: 'CDI' },
